...
import java.io.IOException;  // Importer IOException
import javafx.scene.Parent;  // Importer Parent
import javafx.fxml.FXMLLoader;  // Assurez-vous que cette importation est présente

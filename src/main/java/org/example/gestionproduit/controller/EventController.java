...
public class EventController {
    ...
    private void onAddEventClicked() {
        try {
            ...
            // ⬇️ Obtenir le contrôleur de la page AjouterEvent.fxml
            EventController ajouterController = loader.getController();

            // ⬇️ Passer la référence de ce contrôleur comme parent
    ...
    private void onCreateButtonClicked() {
        ...
        try {
            ...
            // ✅ Recharge localement comme un popup modal (si applicable)
            refreshList();
